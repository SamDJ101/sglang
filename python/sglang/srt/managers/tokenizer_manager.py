...
class TokenizerManager(TokenizerControlMixin, TokenizerManagerScoreMixin):
    ...
    def __init__(
        ...
        *,
        ...
        # Publish first: in a tokenizer-worker process this is the process's
        # first publish, and the in-process path re-projects the object the
        # launcher already published. Constructor work below then runs with the
        # bags in place.
